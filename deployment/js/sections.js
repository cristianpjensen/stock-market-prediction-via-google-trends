function scrollVis() {
    ...
    var xAdjustment = d3.scaleTime()
      .range([0, width]);
    
    var yAdjustment = d3.scaleLinear()
      .domain([0, 100])
      .range([height, 100]);
    
    const lineColors = { 0: foregroundColor, 1: "#E9D758", 2: "#48E5C2", 3: "71A9F7" };
    ...
    function setupVis(adjustmentData, keywordData, tableData) {
        ...
        function make_y_gridlines(yAdjustment) {		
            return d3.axisLeft(yAdjustment)
              .ticks(4)
        ...
        g.append("g")
          ...
          .call(make_y_gridlines(yAdjustment)
            .tickSize(-width)
            .tickFormat("")
          )
    ...
    function unadjustedChart() {
        ...
        g.selectAll(".x.gridlines")
          .transition()
          .duration(500)
            .attr("opacity", 0);
        
        g.selectAll(".y.gridlines")
          .transition()
          .duration(500)
            .attr("opacity", .4);
    ...
    function insertDataTable() {
        ...
        g.selectAll(".table.values.pct_change")
          .attr("opacity", 1);
    ...
    function updatePercentageChange(progress) {
        ...
        for (var i = 0; i < progressInt; i++) {
            g.selectAll(`.table.values.pct_change.e${i}`)
              .attr("opacity", 1);
        };
    ...
    function updateInsert(progress) {
        ...
        for (var i = 0; i < progressInt; i++) {
            g.selectAll(`.table.values.adjusted.e${i}`)
              .attr("opacity", 1);
        };
